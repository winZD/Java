...
/**
 * klasa zadužena za postavljanje komponenti za obradu texta te pridjeljivanju
 * botuna pripadajućim komponentama
 * 
 * @author ivan
 * @since veljaca, 2019.
 */
	...
	private void activateComponents() {
		...
		stopSimulation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				form.frame.stopSimulation.execute();
			}
		});
